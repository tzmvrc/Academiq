    ...
    <div className="space-y-6 max-w-3xl">
      ...
      <BrutalCard color="yellow" className="p-6">
        ...
        <div className="space-y-4">
          ...
          <BrutalButton variant="primary" onClick={handlePasswordChange}>
        ...
        <div className="space-y-4">
          <label className="flex items-center gap-3 p-3 bg-background/50 rounded-lg border-[2px] border-foreground cursor-pointer hover:bg-background transition-colors">
            <Checkbox
              ...
              onCheckedChange={(checked) => setNotifyNewPosts(checked as boolean)}
              className="w-5 h-5"
            />
            <div>
              <span className="font-semibold">New Posts</span>
              <p className="text-sm text-muted-foreground">Get notified when there are new posts in your interests</p>
            </div>
          </label>
          ...
          <label className="flex items-center gap-3 p-3 bg-background/50 rounded-lg border-[2px] border-foreground cursor-pointer hover:bg-background transition-colors">
            <Checkbox
              ...
              onCheckedChange={(checked) => setNotifyComments(checked as boolean)}
              className="w-5 h-5"
            />
            <div>
          ...
          <label className="flex items-center gap-3 p-3 bg-background/50 rounded-lg border-[2px] border-foreground cursor-pointer hover:bg-background transition-colors">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Get notified when you earn points or achieve new ranks</p>
            </div>
          </label>
        </div>
